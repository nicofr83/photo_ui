...
import { MaVieReader } from './MaVieReader';
...
const setup = () => renderWithProviders(<MaVieReader page={page} slug={SLUG} />);
...
describe('V1.7 — "Ma vie", une seule zone de lecture, une phrase par ligne', () => {
